...
const RULES = [
  {
    ...
    body: [
      ...
      "**Tee shot lost short of the grass?** If your drive never reached the fairway or the grass and you can't find it, take your penalty stroke and **drop at the front edge of the grass**. No re-tee, no walking back. Desert carries are not a reason to hold up the group.",
      "**Maximum score on any hole is double par.** Par 3 → 6, par 4 → 8, par 5 → 10. Once you reach it, pick up and write down the max. This is the one time you don't finish the hole.",
      "**Morning rounds — ball in the hole.** No concessions and no gimmies, even in the 2v2 matchplay. Everyone holes out, every hole, unless you've hit double par. The morning rounds are the ones scored for the Individual Championship, so every card has to be real.",
